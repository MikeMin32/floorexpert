  ...
  return (
    <section id="services" className="border-t border-ink/[0.06] bg-white">
      <Container className="pt-16 pb-12 sm:pt-20 sm:pb-14 lg:max-w-[1520px] lg:px-[72px] lg:pt-[72px] lg:pb-14">
        <h2 className="text-[13px] font-semibold uppercase tracking-[0.18em] text-ink-soft/70">
          Послуги з укладання підлоги
        </h2>
        ...
        <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:mt-9 lg:grid-cols-5 lg:gap-6">
          {SERVICE_CARDS.map((service) => (
            <div
              key={service.title}
              className="flex h-full items-start gap-4 rounded-xl border border-ink/10 bg-white px-5 py-5"
            >
              ...
              <div className="flex min-w-0 flex-col">
                ...
                <p className="mt-1.5 line-clamp-3 text-[12px] leading-snug text-ink-soft/55">
                  {service.description}
                </p>
              </div>
            </div>
